            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, rgb(236,72,153) 0%, rgb(168,85,247) ${
                      (distance / 200) * 100
                    }%, rgba(255,255,255,0.08) ${(distance / 200) * 100}%)`,
                  }}
                />
              ...
              <div>
                <span className="text-sm font-bold text-white block mb-3">
                  Show Me
                </span>
                  ...
                  {PREFERENCES.map(pref => {
                    ...
                    return (
                      <button
                        key={pref}
                        onClick={() =>
                          toggleChip(pref, selectedPrefs, setSelectedPrefs)
                        }
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-500 block mb-3">
                  Select all that apply. Visible only to you.
                </span>
                <div className="flex flex-wrap gap-2">
                  {SEXUALITIES.map(s => {
                    ...
                    return (
                      <button
                        key={s}
                        onClick={() =>
                          toggleChip(s, selectedSexuality, setSelectedSexuality)
                        }
                        className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all duration-200 ${
                          active
                        ...
                        style={
                          active
                            ? {
                                background:
                                  'linear-gradient(135deg, rgba(139,92,246,0.6), rgba(79,70,229,0.6))',
