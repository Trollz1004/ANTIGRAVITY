      ...
      <div className="flex items-center justify-between mb-6 animate-fade-in">
        <div>
          ...
          <p className="app-subtitle mt-4 flex items-center gap-2">
            ...
            <Heart size={12} className="text-[#ff4f00]" fill="currentColor" />
          </p>
        </div>
        <button
                    ...
                    {impact.top_organizations.map((org, i) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 text-xs text-gray-500">
                          ...
                          {org.hours > 0 && (
                            <span>{Math.round(org.hours)}h</span>
                          )}
                        </div>
                      </div>
                    ))}
          ...
          <div className="flex flex-wrap gap-2 mb-6 animate-fade-in">
            ...
            {CATEGORIES.map(cat => (
              <button
                ...
                onClick={() =>
                  setFilterCategory(
                    cat.value === filterCategory ? null : cat.value
                  )
                }
                className={`px-4 py-2 rounded-2xl text-xs font-bold transition-all duration-200 ${
          ...
          {opportunities.length === 0 ? (
            <div className="text-center py-20 animate-scale-in">
              ...
              <p className="text-gray-400 max-w-sm mx-auto">
                Start one and make a difference in your community!
              </p>
            </div>
          ) : (
            <LazySection fallback={<SkeletonLoader />}>
