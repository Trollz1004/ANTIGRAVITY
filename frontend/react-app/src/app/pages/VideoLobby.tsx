  ...
  return (
    <div className="km-page mx-auto max-w-lg px-4 py-5">
      ...
      <p className="mt-2 text-sm text-[var(--km-muted)]">
        Video opens from a match. Camera and mic stay local until both people accept.
      </p>
      ...
      <section className="km-card km-card-glow mt-6 p-5">
        ...
        <ul className="mt-3 space-y-2 text-sm text-[var(--km-muted)]">
          <li className="flex gap-2">
            <Shield size={16} className="mt-0.5 shrink-0 text-emerald-400" /> Match first — no cold
            random video.
          </li>
          <li className="flex gap-2">
            <Phone size={16} className="mt-0.5 shrink-0 text-[var(--km-accent)]" /> Open chat → start
            video on the match thread.
          </li>
          <li className="flex gap-2">
            <Video size={16} className="mt-0.5 shrink-0 text-sky-300" /> Powered by Daily.co rooms
            behind <code className="text-xs">/app/video/:matchId</code>.
          </li>
        </ul>
