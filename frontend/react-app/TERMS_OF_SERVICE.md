...
> **Important Notice:** These Terms of Service were drafted without attorney review. They reflect our honest operating rules but have not been reviewed by a licensed attorney. We recommend consulting legal counsel for any questions about your rights or obligations. We intend to have this document professionally reviewed before or shortly after launch.

---

## 1. Agreement to Terms

By creating an account on YouAndINotAI ("the Platform"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the Platform.

These Terms are a legally binding agreement between you and **Trash Or Treasure Online Recycler LLC** ("we," "us," "our"), a Florida single-member LLC operated by Joshua Coleman.

## 2. Eligibility

To use YouAndINotAI, you must:
...
You agree to provide accurate, current, and complete information when creating your account. You agree to update your information if it changes. Do not impersonate another person or use a fake identity.

### 3.2 One Account Per Person

Each person may only have one account. Creating multiple accounts is grounds for termination of all accounts.
...
- Scrape user data or profiles
- Circumvent verification, security measures, or rate limits
- Interfere with the platform's operation or other users' experience
- Attempt to bypass the Bot-Shield verification system
...
You retain ownership of content you post on the platform (photos, bio text, messages). However, by posting content, you grant us a non-exclusive, worldwide, royalty-free license to display, distribute, and use your content as necessary to operate the platform (e.g., showing your profile to other users, displaying your photos in search results).

### 6.2 Content Removal

We reserve the right to remove any content that violates these Terms or that we determine is harmful, without prior notice. You can delete your own content at any time through your account settings.

### 6.3 Content Responsibility

You are solely responsible for the content you post. We do not pre-screen all user content but may review reported content.
...
- You will be charged on the same date each month (or the last day of the month if your start date does not exist in a given month)
- You will receive an email confirmation for each charge
- You can cancel at any time — see Section 7.4
...
### 7.5 Founding Member Rate Lock

The Founding Member rate of $14.99/month is **locked forever** for founding members — meaning as long as your subscription remains active and continuous, your rate will never increase, even if we raise prices for new subscribers.

If you cancel and later resubscribe, you may be subject to the then-current pricing.

### 7.6 Refunds

Refund terms vary by product. See our [Refund Policy](REFUND_POLICY.md) for complete details.
...
- If payment is not resolved, your subscription will be suspended
- You can reactivate by updating your payment method

## 8. Royalty Card Terms

The Royalty Card is a premium, limited-edition product. Only **5 Royalty Cards** will ever be issued.
...
The YouAndINotAI name, logo, branding, website design, codebase, and all original content created by us are the property of Trash Or Treasure Online Recycler LLC. You may not copy, modify, distribute, or create derivative works from our intellectual property without written permission.

### 10.2 Your Property

You retain ownership of content you create and post on the platform. The license you grant us (Section 6.1) is limited to operating the platform.

### 10.3 Third-Party Property

Respect others' intellectual property. If you believe content on our platform infringes your copyright, contact us at joshlcoleman@gmail.com with:
...
YouAndINotAI is provided **"as is"** and **"as available"** without warranties of any kind, express or implied. We specifically disclaim warranties of merchantability, fitness for a particular purpose, and non-infringement.

### 11.2 No Guarantee of Results

We do not guarantee that you will find matches, dates, or relationships. Dating outcomes depend on many factors beyond our control.

### 11.3 No Guarantee of Uptime

We strive for reliable service but do not guarantee 100% uptime. The platform may be unavailable due to maintenance, updates, server issues, or circumstances beyond our control.

### 11.4 User Interactions

We are not responsible for the conduct of users on or off the platform. While we verify identity, we do not conduct criminal background checks. Exercise your own judgment and caution when meeting people online or in person.

### 11.5 AI Limitations

Google Gemini's matchmaking suggestions are just that — suggestions. The AI may occasionally produce inaccurate or unhelpful results. We are not liable for the quality of AI-generated suggestions or icebreakers.
...
You agree to indemnify and hold harmless Trash Or Treasure Online Recycler LLC, Joshua Coleman, and any affiliated parties from any claims, damages, losses, or expenses (including reasonable attorney fees) arising from:
...
Before filing any legal claim, you agree to try to resolve the dispute informally by contacting us at joshlcoleman@gmail.com. We will try to resolve the issue within 30 days.

### 14.3 Jurisdiction

If informal resolution fails, any legal action must be brought in the state or federal courts located in **Florida**. You consent to the personal jurisdiction of these courts.

### 14.4 Class Action Waiver

To the extent permitted by law, you agree to resolve disputes with us on an individual basis. You waive the right to participate in a class action, class arbitration, or any other representative proceeding.

### 14.5 Time Limit

Any claim arising from these Terms or your use of the platform must be filed within **1 year** of the event giving rise to the claim. Claims filed after this period are barred.

## 15. Termination

### 15.1 By You

You can delete your account at any time by contacting us at joshlcoleman@gmail.com. Upon deletion:
...
- Extended inactivity (accounts inactive for more than 24 months may be deleted after notice)
...
- Sections that should survive termination will survive (including Disclaimers, Limitation of Liability, Indemnification, and Dispute Resolution)
- We are not obligated to refund any payments upon termination for cause (violation of Terms)
...
- For material changes, we will notify you by email or a prominent notice on the platform at least 14 days before the changes take effect
- Your continued use of the platform after the effective date constitutes acceptance
- If you do not agree to the updated Terms, you must stop using the platform and delete your account

## 17. Miscellaneous

### 17.1 Entire Agreement

These Terms, together with our Privacy Policy and Refund Policy, constitute the entire agreement between you and Trash Or Treasure Online Recycler LLC regarding your use of YouAndINotAI.
...
We may assign our rights and obligations under these Terms without your consent (e.g., in the event of a merger or acquisition). You may not assign your rights under these Terms.

### 17.5 Force Majeure

We are not liable for any failure or delay in performing our obligations due to circumstances beyond our reasonable control, including natural disasters, war, terrorism, pandemics, government actions, or internet outages.
...
_These Terms of Service were drafted by the founder with AI assistance and have not yet been reviewed by a licensed attorney. Users are encouraged to read them carefully. The operator intends to obtain professional legal review._
