...
### 2.2 Founding Member Monthly Subscription — $14.99/month

**Cancel anytime. No refund for partial months.**

- You can cancel your subscription at any time
- When you cancel, your access continues through the end of your current billing period
- You will not be charged again after cancellation
- We do **not** issue refunds for unused days in your current billing period
...
The same rules as the 3-Month Plan apply:

- **Within 14 days of purchase:** Full refund available if no matches have been made. If matches have been made, prorated refund only.
- **After 14 days:** Prorated refund based on unused days remaining.
  - Example: If you cancel after 60 days of a 365-day plan, you have 305 days remaining. Refund = (305/365) x $99.99 = $83.55.
- **No refund after the 12-month period ends.**

### 2.5 Royalty Card — $2,500
...
To request a refund, email **joshlcoleman@gmail.com** with the following information:

- **Subject line:** "Refund Request"
- **Your name** (as it appears on your account)
- **Your email address** (the one associated with your account)
- **Product purchased** (Bot-Shield, Monthly, 3-Month, 12-Month, or Royalty Card)
- **Date of purchase**
...
We prefer to handle refund requests directly. If you have an issue, please email us before filing a chargeback with your bank.

Filing a chargeback (disputing a charge with your bank or credit card company) without contacting us first may result in:
...
We understand that life happens. If you have a situation that does not fit neatly into the categories above, email us and explain. We will consider refund requests on a case-by-case basis for:

- Medical emergencies
- Accidental purchases (e.g., a child made a purchase on your device)
- Technical issues that prevented you from using the service
- Billing errors or duplicate charges

We are a small operation run by one person. We are not trying to keep your money unfairly. If something went wrong, reach out and we will try to make it right.
...
- Changes will not apply retroactively to purchases made before the update
- For material changes, we will notify users by email or a prominent notice on the platform
