...
- T5500 node (192.168.0.15) = Production. Online.
- SABRETOOTH (192.168.0.8) = Dev. Currently offline.
- 9020 (192.168.0.5) = Dev secondary. Currently offline.
- Cloud Run: youandinotai-com-731395189513.us-west1.run.app (ANTIGRAVITY dashboard)

## PAYMENT STATUS

- Stripe: ✅ Live and connected
- Square: ⚠️ Bot-Shield link needs fixing
- Plaid: ✅ Production
- Coinbase CDP: ✅ Connected
...
- **Manus**: **Long-Term Infrastructure & Governance Lead**. Responsible for autonomous stewardship, ethical revenue routing, and 50-year legacy preservation for #ForTheKids. Ensures the **Iron Wall** remains unbreachable.
...
- Hit $19,990 in pre-orders by April 4, 2026
- Fix Square Bot-Shield payment link
- Get SABRETOOTH and 9020 nodes back online (need revenue first)
- Improve pitch deck score from 57% to 80%+
