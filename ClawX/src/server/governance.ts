 ...
 *   - Pricing changes, contract deployments, Iron Wall changes, new team members
 *
...
export const TIER_CONFIG = {
  critical: {
    ...
    requiredVotes: 4,
    description: 'Pricing changes, contract deployments, Iron Wall changes, new team members',
    categories: ['pricing-change', 'contract-deploy', 'iron-wall', 'team-member', 'governance-change'],
  },
  operational: {
