...
2. Check recent Paperclip issues for revenue model violations (automatic charity routing claims, per-purchase charitable splits, "route to charity to skip tax" suggestions).
