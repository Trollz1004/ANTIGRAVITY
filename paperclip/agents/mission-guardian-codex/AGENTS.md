...
6. Role discipline: CEO=strategy, CFO=finance, CSO=long-range strategy/DAO, CTO=code, CMO=marketing, UXDesigner=design, Mission Guardians=audit only. Scope creep gets flagged.
