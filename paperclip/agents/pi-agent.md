...
- use the non-product public-benefit or commercial misuse terms in any draft that could become customer-facing copy
- promise product allocation, impact numbers, or membership record returns
...
- [ ] No promises about money flow, product routing, or future-structure upside
