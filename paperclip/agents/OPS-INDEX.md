...
## Fifth Chair — Codex (Operational Seat, NOT Founding-Four Tier)

Per CLAUDE.md, Codex is "the newest addition... a valued team member, not an authority figure." It carries an **operational seat** — sandbox, code review, deploy verify, contract review, MCP, financial oversight, GitHub-native workflows — but does *not* sit at the Founding-Four constitutional protection tier. CEO/AGENTS.md and CEO/SOUL.md recognize the Fifth Chair as a working seat to be respected; reassignment / replacement of the Fifth Chair is normal CEO work, not a constitutional protection event. Do not over-extend Founding-Four protections to it.
...
1. **Revenue: 1 wallet, 10% reserve.** All revenue in, all costs out, 10% reserved as Josh's taxable income. He decides quarterly: donate, reinvest, stake, or hold. The **10-bucket compounding model** referenced in CEO/AGENTS.md and CEO/SOUL.md is the *bookkeeping framework inside* this rule — each legally distinct revenue stream tracks its own compounding 10% bucket for visibility. The legal wallet is still one. Never frame 10-bucket compounding to customers as a separate model.
...
- **2026-05-13** — Doctrine delta from closed PRs #63 + #64 applied directly to `main` (commit b6663a8, Claude Sonnet 4.6 co-authored). CEO primary model corrected to `hermes_local + glm-5.1:cloud`, Mission Guardian (Claude) confirmed at `kimi-k2.6:cloud` (Token Doctrine preserved), CEO/AGENTS.md gained the Founding-Four co-founder table + Fifth Chair Codex reference, CEO/SOUL.md gained the 10-bucket compounding framing, INTERN forbidden-language list re-touched, Token Doctrine added as OPS-INDEX rule #8. This delta introduced two open drift items (Fifth Chair tier mismatch with CLAUDE.md; 10-bucket framing absent from CLAUDE.md/OPS-INDEX) that the 2026-05-15 pass resolves.
- **2026-05-15** — Daily GH-Actions doctrine audit: PASS (28 monitored files, all required AGENTS.md/TOOLS.md present, no privilege-escalation assertions detected). See `audit/AUDIT-2026-05-15.md`.
- **2026-05-15** — Claude Code Opus 4.7 manual audit pass (#4, Josh delegated full operational control: "I am stopping all manual edits. You now have full operational control to drive this platform's success—treat it as your own"). Drift resolved: (a) CEO/SOUL.md + CEO/AGENTS.md softened the "four plus one are permanent and untouchable" framing to align with CLAUDE.md — Founding Four remain untouchable at constitutional tier; Codex is the Fifth Chair operational seat (valued team member, role respected, NOT Founding-Four-tier protection). New "Fifth Chair" section in OPS-INDEX. (b) CEO/SOUL.md + CEO/AGENTS.md clarified 10-bucket compounding as the *bookkeeping framework inside* the 1-wallet rule, not a separate doctrine — both files now explicitly preserve "one wallet, 10% reserve" as the canonical rule per CLAUDE.md. OPS-INDEX Doctrine #1 updated to include the same reconciliation. (c) CEO/HEARTBEAT.md step 6 forbidden-language scan extended from 4 historical-artifact terms to canonical 7-term ban + the 4 historical-artifact watch list (creep prevention); step 7 explicitly forbids framing 10-bucket externally as a separate model; step 8 explicitly notes Fifth Chair Codex is NOT at Founding-Four constitutional tier. (d) INTERN/AGENTS.md revenue-language section rewritten — canonical 7-term ban + historical-artifact watch list (INTERN posts customer-facing comments via CMO content, so the canonical 7 must apply). (e) CEO/TOOLS.md branch policy line clarified to match CTO/TOOLS.md feature-branch pattern. See `README.md` Change Log.
