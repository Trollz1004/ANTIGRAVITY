...
`;
  ...
  it("suppresses secret-like comment and document bodies before storing distillation snapshots", async () => {
    ...
    harness.seed({
      ...
      issueComments: [{
        ...
        authorAgentId: null,
        authorUserId: null,
        body: "Authorization: Bearer ***REMOVED***",
        presentation: null,
        metadata: null,
    ...
    expect(run.bundle.markdown).not.toContain("***REMOVED***");
    expect(run.bundle.markdown).not.toContain("***REMOVED***");
    ...
    expect(storedMarkdown).not.toContain("***REMOVED***");
    expect(storedMarkdown).not.toContain("***REMOVED***");
  });
  ...
  it("keeps suppressed secret-like source content out of generated wiki patches", async () => {
    ...
    expect(combinedPatchContents).not.toContain("***REMOVED***");
    expect(combinedPatchContents).not.toContain("***REMOVED***");
  });
