...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo        Dir:  C:\ANTIGRAVITY-git
    echo        Data: C:\Users\joshl\.paperclip\instances\default
    start "Paperclip HQ :3100" cmd /k "cd /d C:\ANTIGRAVITY-git && paperclipai run"
...
echo        WSL venv: /home/josh/.hermes/hermes-agent/venv/bin/hermes
call hermes --version >nul 2>&1
if %ERRORLEVEL% EQU 0 (
...
::     start "Web :3000" cmd /k "cd /d C:\ANTIGRAVITY-git\antigravity && pnpm dev"
...
::     start "CmdCenter :3001" cmd /k "cd /d C:\ANTIGRAVITY-git\apps\command-center && pnpm dev"
::     timeout /t 4 /nobreak >nul
:: )
...
::     start "Dashboard :5173" cmd /k "cd /d C:\ANTIGRAVITY-git\apps\dashboard && pnpm dev"
::     timeout /t 4 /nobreak >nul
:: )
...
::     start "ClawX :5174" cmd /k "cd /d C:\ANTIGRAVITY-git\ClawX && pnpm dev"
::     timeout /t 4 /nobreak >nul
:: )
