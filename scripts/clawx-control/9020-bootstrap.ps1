...
Write-Host "     cd E:\ANTIGRAVITY && docker compose up -d" -ForegroundColor White
Write-Host "  7. Copy master .env from 9020 SSD to E:\ANTIGRAVITY\.env" -ForegroundColor White
