...
SEO_ARTICLES = [
    {
        ...
        "meta_description": "60% of dating app users suspect they've matched with AI bots. Learn how to identify bots and discover YouAndINotAI — the only dating app with V8 Cloud Verification powered by Plaid.",
