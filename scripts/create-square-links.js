  ...
  const products = [
    {
      ...
      desc: 'Repository audit, doctrine purge, secret rotation, compliance scan.',
      price: 1500,
    },
    {
      name: 'Agentic Workflows',
      desc: 'Multi-agent orchestration, swarm deployment, autonomous task execution.',
      price: 2500,
    },
    {
      name: 'Storefront Deployment',
      desc: 'Digital storefront deployment with Square checkout, affiliate links.',
      price: 950,
    },
    {
      name: 'Tech Debt Cleanup',
      desc: 'Legacy code modernization, dependency updates, architecture refactoring.',
      price: 4000,
    },
      ...
      if (catResult.status !== 200 || !catResult.data.catalog_object) {
        console.log(
          'Catalog failed: ' +
            ...
            catResult.status +
            ' ' +
            JSON.stringify(catResult.data).substring(0, 200),
        );
      ...
      if (linkResult.status === 200 && linkResult.data.link) {
        ...
        console.log(
          'Link failed: ' +
            ...
            linkResult.status +
            ' ' +
            JSON.stringify(linkResult.data).substring(0, 200),
        );
        links[p.name] = 'https://square.link/u/eMyJvw8D?ref=clean-repo';
      }
    } catch (e) {
  ...
  const revenueData = {
    ...
    revenue_streams: {
      security_cleanup: {
        ...
        bucket: 1,
        square_link: links['Security Cleanup'],
      ...
      agentic_workflows: {
        ...
        bucket: 2,
        square_link: links['Agentic Workflows'],
        landing: 'E:/ANTIGRAVITY/apps/youandinotai-static/landing-revenue.html',
      },
      storefront_deployment: {
        ...
        bucket: 5,
        square_link: links['Storefront Deployment'],
        landing: 'E:/ANTIGRAVITY/apps/youandinotai-static/landing-revenue.html',
      },
      tech_debt_cleanup: {
        name: 'Tech Debt Cleanup',
        sprint_cost: 4000,
        bucket: 7,
        square_link: links['Tech Debt Cleanup'],
        landing: 'E:/ANTIGRAVITY/apps/youandinotai-static/landing-revenue.html',
      },
      api_management: {
        name: 'API Management',
        ...
        bucket: 8,
        square_link: links['API Management'],
        landing: 'E:/ANTIGRAVITY/apps/youandinotai-static/landing-revenue.html',
      },
    },
    landing_pages: {
