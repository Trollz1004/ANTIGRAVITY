...
create table if not exists public.revenue_allocations (
    ...
    cause_amount_cents integer,
    operating_amount_cents integer,
    cause_percent integer not null default 10,
...
alter table public.revenue_allocations
    ...
    add column if not exists cause_amount_cents integer,
    add column if not exists operating_amount_cents integer,
    add column if not exists cause_percent integer not null default 10,
...
alter table public.revenue_allocations
    ...
    alter column cause_percent set default 10,
