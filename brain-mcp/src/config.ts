...
const DEFAULT_PLATFORMS: PlatformDefinition[] = [
  {
    ...
    blockedPathPrefixes: ["C:\\OMEGA", "C:\\OMEGA365"],
  },
  {
    ...
    certificationAuthority: true,
    allowedIps: ["127.0.0.1", "192.168.0.8"],
    allowedPathPrefixes: ["C:\\ANTIGRAVITY", "E:\\claudes-claw"],
    blockedPathPrefixes: ["C:\\OMEGA", "C:\\OMEGA365"],
  },
  {
  ...
  },
  {
    ...
    blockedPathPrefixes: ["C:\\ANTIGRAVITY", "C:\\OMEGA", "C:\\OMEGA365"],
  },
  {
    id: "genspark-9020",
...
export function loadBrainConfig(): BrainConfig {
  ...
  const dataDir =
    ...
    path.join(canonicalRepoRoot, "logs", "brain-mcp");
  ...
  const sessionTtlMinutes = Number.parseInt(
    process.env.BRAIN_SESSION_TTL_MINUTES ?? "120",
    10,
  );
  ...
  return {
    ...
    http: {
      ...
      requireAuth:
        (process.env.BRAIN_REQUIRE_AUTH ?? "true").toLowerCase() === "true",
    },
  };
}
