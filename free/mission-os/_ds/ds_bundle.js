/* @ds-bundle: {"format":3,"namespace":"ANTIGRAVITYDesignSystem_58589b","components":[{"name":"Avatar","sourcePath":"components/core/Avatar.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"GlassPanel","sourcePath":"components/core/GlassPanel.jsx"},{"name":"MonoLabel","sourcePath":"components/core/MonoLabel.jsx"},{"name":"StatCard","sourcePath":"components/data/StatCard.jsx"},{"name":"Badge","sourcePath":"components/feedback/Badge.jsx"},{"name":"StatusPill","sourcePath":"components/feedback/StatusPill.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"ProductChip","sourcePath":"components/navigation/ProductChip.jsx"},{"name":"SurfaceLink","sourcePath":"components/navigation/SurfaceLink.jsx"}],"sourceHashes":{"components/core/Avatar.jsx":"35c8e13537d6","components/core/Button.jsx":"a173cf32497a","components/core/GlassPanel.jsx":"0b4acc0207df","components/core/MonoLabel.jsx":"fd2dc5316045","components/data/StatCard.jsx":"799dfee8771c","components/feedback/Badge.jsx":"79ea3ed88756","components/feedback/StatusPill.jsx":"c5fb5a79a295","components/forms/Input.jsx":"c532e76863b0","components/navigation/ProductChip.jsx":"678889ecb607","components/navigation/SurfaceLink.jsx":"adcc865d58f8","decks/deck-stage.js":"e529c4de2f18","ui_kits/mission-control/app.jsx":"4d18eb67f2cf","ui_kits/youandinotai/app.jsx":"ee5cefd941ca","ui_kits/youandinotai/icon.jsx":"da63007b9c2b","ui_kits/youandinotai/sections.jsx":"e05a558e46ca"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.ANTIGRAVITYDesignSystem_58589b = window.ANTIGRAVITYDesignSystem_58589b || {});
...
function GlassPanel({
  ...
  return /*#__PURE__*/React.createElement(Tag, _extends({
    ...
    style: {
      ...
      boxShadow: glow ? 'var(--ag-shadow-glass), var(--ag-glow-cyan)' : 'var(--ag-shadow-glass)',
      borderRadius: radii[radius] || radii.card,
      padding: pads[pad] != null ? pads[pad] : pads.card,
      transition: 'var(--ag-transition)',
      transform: hover ? 'translateY(-4px)' : 'none',
      ...(hover ? {
        borderColor: 'var(--ag-border-cyan)'
      } : {}),
      ...style
    }
  }, rest), children);
...
function StatCard({
  ...
  }, icon), live && !icon && /*#__PURE__*/React.createElement("span", {
    style: {
      width: 7,
      height: 7,
      borderRadius: '50%',
  ...
  }, value), note && /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--ag-font-sans)',
      fontSize: 'var(--ag-text-xs)',
      lineHeight: 1.5,
...
function Badge({
  ...
  const tones = {
    cyan: {
      c: 'var(--ag-cyan)',
      solidBg: 'var(--ag-cyan-deep)',
      solidFg: 'var(--ag-bg)'
    },
    pink: {
      c: 'var(--ag-pink)',
      solidBg: 'var(--ag-pink-deep)',
      solidFg: '#fff'
    },
    rose: {
      c: 'var(--ag-rose)',
    ...
    slate: {
      c: 'var(--ag-text-muted)',
      solidBg: 'var(--ag-surface-2)',
      solidFg: 'var(--ag-text)'
    },
    success: {
      c: 'var(--ag-success)',
      solidBg: 'var(--ag-success)',
      solidFg: 'var(--ag-bg)'
    }
  };
...
function StatusPill({
  ...
  }), label || s.t, /*#__PURE__*/React.createElement("style", null, `@keyframes ag-pulse { 0%,100% { opacity: 1 } 50% { opacity: 0.35 } }`));
}
...
// components/navigation/ProductChip.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/ProductChip.jsx", error: String((e && e.message) || e) }); }

// components/navigation/SurfaceLink.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function SurfaceLink({
  ...
  }, icon)), description && /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--ag-font-sans)',
      fontSize: 'var(--ag-text-sm)',
      lineHeight: 1.55,
...
Object.assign(__ds_scope, { SurfaceLink });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/SurfaceLink.jsx", error: String((e && e.message) || e) }); }
...
const NODES = [{
  name: 'Sabretooth',
  ip: '192.168.0.8',
  role: 'Master · Orchestration + GPU Ollama',
  status: 'live',
  accent: 'var(--ag-cyan)'
}, {
  name: 'T5500',
  ip: '192.168.0.15',
  role: 'Tunnels · Domains + Payments',
  status: 'active',
  accent: 'var(--ag-pink)'
}, {
  name: '9020',
  ip: '192.168.0.5',
  role: 'Dev · Interactive node',
  status: 'active',
...
const COMPANIES = [{
  name: 'You & I Not Ai',
  kind: 'Dating · Square rail',
  status: 'active'
}, {
  name: 'Business Exchange',
  kind: 'Marketplace · 9020',
  status: 'active'
}, {
  name: 'Online Recycle',
  kind: 'E-waste intake',
  ...
  name: 'Hermes Side World',
  kind: 'AI router · infra',
  status: 'live'
}];
function NodeCard({
  n
  ...
  }, n.ip)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--ag-font-mono)',
      fontSize: 10,
      color: 'var(--ag-text-muted)',
  ...
  }, n.role)), /*#__PURE__*/React.createElement(MC_Status, {
    status: n.status
  }));
}
function AgentCard({
  ...
  }, /*#__PURE__*/React.createElement(MC_Avatar, {
    name: a.role,
    ring: `var(--ag-${a.tone === 'slate' ? 'slate-600' : a.tone})`,
    size: 38
  ...
  }, a.role), /*#__PURE__*/React.createElement(MC_Label, null, a.cat))), /*#__PURE__*/React.createElement(MC_Status, {
    status: a.status
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, /*#__PURE__*/React.createElement(MC_Badge, {
    tone: "slate"
  }, /*#__PURE__*/React.createElement(MCIcon, {
    name: "cpu",
    size: 11
  }), " ", a.model), /*#__PURE__*/React.createElement(MC_Label, {
    color: "var(--ag-text-muted-deep)"
  }, /*#__PURE__*/React.createElement(MCIcon, {
    name: "activity",
    size: 11
...
function MCApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      zIndex: 0,
      pointerEvents: 'none',
      background: 'radial-gradient(70% 50% at 50% -5%, rgba(34,211,238,.08), transparent 60%)'
    }
    ...
    src: "../../assets/logo/logo-dark-bg-512.png",
    alt: "",
    style: {
      width: 32,
      height: 32
  ...
  }, "ANTIGRAVITY \xB7 MISSION CONTROL"), /*#__PURE__*/React.createElement(MC_Label, {
    color: "var(--ag-text-muted-deep)"
  }, "Hermes fleet orchestration"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 14
    }
  }, /*#__PURE__*/React.createElement(MC_Status, {
    status: "live",
    label: "Sabretooth \xB7 Master"
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--ag-font-mono)',
      fontSize: 12,
  ...
  }, clock))), /*#__PURE__*/React.createElement("main", {
    style: {
      position: 'relative',
      zIndex: 10,
      maxWidth: 1280,
    ...
    label: "Agents Online",
    value: "4 / 7",
    note: "Hermes fleet heartbeat in the last 60s.",
    accent: "cyan",
    live: true
  }), /*#__PURE__*/React.createElement(MC_Stat, {
    label: "Companies",
    value: "4",
    note: "Active boards wired to the fleet.",
    accent: "pink"
  }), /*#__PURE__*/React.createElement(MC_Stat, {
    label: "Default Model",
    value: "qwen2.5:7b",
    note: "Ollama @ 192.168.0.8 \xB7 GPU node.",
    accent: "gold"
  }), /*#__PURE__*/React.createElement(MC_Stat, {
    label: "Kids Reserve",
    value: "10%",
  ...
  }, /*#__PURE__*/React.createElement(MC_Panel, {
    radius: "card",
    pad: "panel"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    className: "ag-section-heading",
    style: {
      fontSize: 'var(--ag-text-xl)',
      textTransform: 'uppercase'
    }
  }, "Agent fleet")), /*#__PURE__*/React.createElement(MC_Btn, {
    variant: "outline",
    size: "sm",
    icon: /*#__PURE__*/React.createElement(MCIcon, {
      name: "refresh-cw",
      size: 13
    })
  }, "Sync heartbeat")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))',
      gap: 12
    }
  }, FLEET.map(a => /*#__PURE__*/React.createElement(AgentCard, {
    key: a.role,
    a: a
  })))), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    className: "ag-section-heading",
    style: {
      fontSize: 'var(--ag-text-lg)',
      textTransform: 'uppercase'
    }
  }, "Node topology")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    }
  }, NODES.map(n => /*#__PURE__*/React.createElement(NodeCard, {
    key: n.name,
    n: n
  })))), /*#__PURE__*/React.createElement(MC_Panel, {
    radius: "card",
  ...
  }, c.name), /*#__PURE__*/React.createElement(MC_Label, {
    color: "var(--ag-text-muted-deep)"
  }, c.kind)), /*#__PURE__*/React.createElement(MC_Status, {
    status: c.status
  ...
  }, "One AI does not command another \xB7 Joshua is sole authority \xB7 No mock data")));
}
...
window.__mountMC = function mountMC() {
  ...
  if (!NS || !NS.Button) {
    return setTimeout(window.__mountMC, 30);
  }
  ({
    GlassPanel: MC_Panel,
    MonoLabel: MC_Label,
    StatusPill: MC_Status,
    StatCard: MC_Stat,
    Badge: MC_Badge,
    Button: MC_Btn,
    Avatar: MC_Avatar
  } = NS);
  ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(MCApp, null));
};
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/mission-control/app.jsx", error: String((e && e.message) || e) }); }

// ui_kits/youandinotai/app.jsx
try { (() => {
...
function YINApp() {
  const {
    Button: AGButton,
    MonoLabel: AGMonoLabel
  } = window.ANTIGRAVITYDesignSystem_58589b;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      zIndex: 0,
      pointerEvents: 'none',
      background: 'radial-gradient(80% 60% at 85% -5%, rgba(34,211,238,.10), transparent 55%), radial-gradient(80% 60% at 5% 105%, rgba(236,72,153,.10), transparent 55%)'
    }
  }), /*#__PURE__*/React.createElement("header", {
    style: {
      position: 'sticky',
    ...
    className: "ag-brand-heading",
    style: {
      fontWeight: 800,
      fontSize: 18
    }
  }, "YouAndINotAI")), /*#__PURE__*/React.createElement("nav", {
    style: {
      display: 'flex',
      gap: 4
    }
    ...
    style: {
      ...
      textTransform: 'uppercase',
      letterSpacing: '0.15em',
      color: navActive === n.id ? 'var(--ag-cyan)' : 'var(--ag-text-muted)',
      background: 'transparent',
      border: 'none',
      cursor: 'pointer',
      padding: '8px 12px',
  ...
  }, /*#__PURE__*/React.createElement(AGMonoLabel, {
    dot: true,
    color: "var(--ag-cyan)"
  }, "Live"), /*#__PURE__*/React.createElement(AGButton, {
    variant: "neon",
    size: "sm",
    icon: /*#__PURE__*/React.createElement(YINIcon, {
      name: "shield-check",
      size: 14
    })
  }, "Verify")))), /*#__PURE__*/React.createElement("main", {
    style: {
      position: 'relative',
      zIndex: 10,
      maxWidth: 1100,
    ...
    id: "sec-platform"
  }, /*#__PURE__*/React.createElement(window.YIN_Hero, null)), /*#__PURE__*/React.createElement("div", {
    id: "sec-platform-stats"
  }, /*#__PURE__*/React.createElement(window.YIN_StatusGrid, null)), /*#__PURE__*/React.createElement("div", {
    id: "sec-membership"
  }, /*#__PURE__*/React.createElement(window.YIN_MembershipGrid, {
    selected: selected,
    onSelect: setSelected
  })), /*#__PURE__*/React.createElement("div", {
    id: "sec-surfaces"
  }, /*#__PURE__*/React.createElement(window.YIN_SurfacesGrid, null)), /*#__PURE__*/React.createElement("div", {
    id: "sec-mission"
  }, /*#__PURE__*/React.createElement(window.YIN_MissionPanel, null)), /*#__PURE__*/React.createElement("footer", {
    style: {
      textAlign: 'center',
      padding: '24px 0 0',
      borderTop: '1px solid var(--ag-border)',
...
window.__mountYIN = function mountYIN() {
  const NS = window.ANTIGRAVITYDesignSystem_58589b;
  if (!NS || !NS.Button || !window.YIN_Hero) {
    return setTimeout(window.__mountYIN, 30);
  }
  ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(YINApp, null));
};
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/youandinotai/app.jsx", error: String((e && e.message) || e) }); }

// ui_kits/youandinotai/icon.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/youandinotai/icon.jsx", error: String((e && e.message) || e) }); }

// ui_kits/youandinotai/sections.jsx
try { (() => {
...
const SURFACES = [{
  ...
  tone: 'success',
  icon: 'heart',
  desc: 'Dating and community platform with Bot-Shield verification, message boards, and memberships.'
}, {
  name: 'Business Exchange',
  status: 'Live marketplace',
  tone: 'cyan',
  icon: 'handshake',
  desc: 'Marketplace for services, referrals, and business sales. The B2B routing layer for the ecosystem.'
}, {
  name: 'OnlineRecycle',
  status: 'Live product',
  tone: 'success',
  icon: 'recycle',
  desc: 'Electronics recycling, pickup, and resale intake for Central Florida customers.'
}, {
  ...
  tone: 'paused',
  icon: 'coins',
  desc: 'Review-gated mechanics are offline until attorney review is complete.'
}, {
  name: 'Customer Support',
  status: 'Active',
  tone: 'gold',
  icon: 'life-buoy',
  desc: 'Direct support surface — visible, reachable, not buried. A trust signal and conversion layer.'
}];
...
function Hero() {
  ...
  return /*#__PURE__*/React.createElement(GlassPanel, {
    ...
    style: {
      textAlign: 'center',
      background: 'radial-gradient(120% 90% at 80% 0%, rgba(34,211,238,.12), transparent 55%), radial-gradient(120% 90% at 0% 100%, rgba(236,72,153,.14), transparent 55%), var(--ag-glass-fill)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
    ...
    dot: true,
    color: "var(--ag-cyan)"
  }, "No Bots \xB7 Real Humans")), /*#__PURE__*/React.createElement("h1", {
    className: "ag-brand-heading",
    style: {
      fontSize: 'var(--ag-text-5xl)',
      fontWeight: 900,
      letterSpacing: '-0.02em',
      lineHeight: 1.02,
      margin: 0
    }
  }, "YouAndINotAI"), /*#__PURE__*/React.createElement("p", {
    style: {
      maxWidth: '46ch',
      margin: '20px auto 0',
      color: 'var(--ag-text-body)',
  ...
  }, "A human-first social platform for builders, operators, and people who actually do the work. Verified people only \u2014 no bots, no theater."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      justifyContent: 'center',
  ...
  }, "Dating & Community"), /*#__PURE__*/React.createElement(ProductChip, {
    tone: "success",
    icon: /*#__PURE__*/React.createElement(Icon, {
      name: "handshake",
      size: 15
    })
  }, "Business Exchange"), /*#__PURE__*/React.createElement(ProductChip, {
    tone: "purple",
    icon: /*#__PURE__*/React.createElement(Icon, {
      name: "coins",
      size: 15
  ...
  }, "Support \u2014 Active")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      gap: 12,
  ...
  }, "Verify as human \xB7 $1"), /*#__PURE__*/React.createElement(Button, {
    variant: "outline",
    size: "lg",
...
function MembershipGrid({
  ...
  return /*#__PURE__*/React.createElement(GlassPanel, {
    ...
    className: "ag-section-heading",
    style: {
      fontSize: 'var(--ag-text-2xl)',
      textTransform: 'uppercase'
    }
  }, "Become a founding member")), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'var(--ag-text-body)',
      maxWidth: '60ch',
      margin: '0 0 24px',
  ...
  }, "Pick a plan and check out securely through Square. Founding members get full access and permanent recognition as the platform grows."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    }, isSel ? 'Selected' : 'Check out', " ", /*#__PURE__*/React.createElement(Icon, {
      name: isSel ? 'check' : 'arrow-up-right',
      size: 15
    })));
...
function StatusGrid() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: "1,204",
    note: "Bot-Shield human verification confirmed \u2014 real people only.",
    accent: "gold",
    live: true
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Kids Reserve",
    value: "10%",
    note: "Reserved share of net revenue. Recorded values only, never projections.",
    accent: "pink"
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Tracking Status",
    value: "Live",
    note: "Operational detail stays private until it is safe to publish.",
    accent: "success",
    live: true
  }));
}
...
function SurfacesGrid() {
  ...
  }, "Public surfaces")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
...
function MissionPanel() {
  ...
  return /*#__PURE__*/React.createElement(GlassPanel, {
    ...
    style: {
      textAlign: 'center',
      background: 'radial-gradient(100% 120% at 50% 0%, rgba(244,63,94,.10), transparent 60%), var(--ag-glass-fill)'
    }
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "heart",
    size: 32,
    ...
    style: {
      margin: '0 auto 14px',
      filter: 'drop-shadow(var(--ag-glow-pink))'
    }
  }), /*#__PURE__*/React.createElement("h2", {
    className: "ag-section-heading",
    style: {
  ...
  }, "Operating principle"), /*#__PURE__*/React.createElement("p", {
    style: {
      maxWidth: '52ch',
      margin: '0 auto',
      color: 'var(--ag-text-body)',
  ...
  }, "Build useful products first, report only verified numbers, and keep legal-review items offline until they are ready. ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--ag-pink)',
      fontWeight: 700
    }
...
Object.assign(window, {
  YIN_Hero: Hero,
  YIN_MembershipGrid: MembershipGrid,
  YIN_StatusGrid: StatusGrid,
  YIN_SurfacesGrid: SurfacesGrid,
  YIN_MissionPanel: MissionPanel
});
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/youandinotai/sections.jsx", error: String((e && e.message) || e) }); }
...
__ds_ns.SurfaceLink = __ds_scope.SurfaceLink;
