...
function SignupCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-4 py-3 flex items-center justify-center gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.4)] flex-wrap">
      ...
      <a
        href="https://square.link/u/Obm0Ittl"
        target="_blank"
...
function PricingSection() {
  const plans = [
    { name: 'Bot-Shield Verification', price: '$1', desc: "Prove you're real", link: 'https://square.link/u/Obm0Ittl', bg: 'from-indigo-500 to-purple-600' },
    { name: 'Founding Member', price: '$14.99/mo', desc: 'Locked forever at this rate', link: 'https://square.link/u/lHz9ZjPy', bg: 'from-purple-600 to-pink-600' },
    { name: '3-Month Founder', price: '$39.99', desc: 'Save $5 vs monthly', link: 'https://square.link/u/FA6Z7TZp', bg: 'from-blue-600 to-indigo-600' },
    { name: '12-Month Founder', price: '$99.99', desc: 'Best value — save $80', link: 'https://square.link/u/txPocu3j', bg: 'from-indigo-700 to-blue-700' },
    { name: 'Royalty Card', price: '$2,500', desc: 'Lifetime VIP + revenue share', link: 'https://square.link/u/gpbxDphN', bg: 'from-amber-400 to-orange-500' },
  ];
...
function Footer({ onLegal }: { onLegal: (type: string) => void }) {
  const plans = [
    { name: 'Bot-Shield — $1', link: 'https://square.link/u/Obm0Ittl' },
    { name: 'Founding Member — $14.99/mo', link: 'https://square.link/u/lHz9ZjPy' },
    { name: '3-Month Founder — $39.99', link: 'https://square.link/u/FA6Z7TZp' },
    { name: '12-Month Founder — $99.99', link: 'https://square.link/u/txPocu3j' },
    { name: 'Royalty Card — $2,500', link: 'https://square.link/u/gpbxDphN' },
  ];
