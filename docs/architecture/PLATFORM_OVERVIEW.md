...
## Repo Boundary
- This repository is a public monorepo for product code and selected operational docs.
- Private credentials, sensitive runbooks, and internal-only procedures are excluded from public docs.
