...
const WORKERS = [
  { id: 'hermes', name: 'Hermes',     role: 'Router · Grok sign-in',  kind: 'hermes', status: 'live', state: 'STREAMING · auth-only', body: 'Grok sign-in auth · no API key · scoped to x.com surface.', tags: [['live','GROK AUTH'], ['amber','XAI']], busy: true, leadBy: 'opus' },
    ...
    <div className={"agent-card " + (agent.busy ? 'is-busy' : '')}>
      <div className="agent-head">
        <div className={"agent-glyph " + agent.kind}>
          ...
          {agent.kind === 'grok'   && <Icon.Grok size={18}/>}
