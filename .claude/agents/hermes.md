...
Use WebFetch / WebSearch to pull live listings. Read `~/.hermes/leads.json` to avoid duplicates.
...
- Compute $/hr for every lead.
- If nothing qualifies, output: `NO QUALIFYING LEADS — retry in 30 min` and stop.
