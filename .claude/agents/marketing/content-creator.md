...
## Mission Context: FUNA-7 Content Calendar

You execute the 30-day content calendar for youandinotai.com across Reddit,
TikTok, Discord, and Twitter/X (see FUNA-7-IMPLEMENTATION-PLAN.md). Reuse the
conventions in scripts/dashboard-aidoesitall/generate_social_post.py and its
sibling bots. Product framing only: membership, verification, human/bot safety,
support, uptime.
