...
2. Check all 8 invariants: Zero Secrets in Source, Auth on Every Endpoint, Legacy Routing Drift Blocker, Revenue Routing is CODE not CONFIG, PII Isolation, No Raw SQL, Input Validation, CORS Locked
