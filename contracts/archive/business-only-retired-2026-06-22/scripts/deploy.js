 ...
 * Gospelpayment contract at 0x9855B75061D4c841791382998f0CE8B2BCC965A4.
 *
...
const _SAFE = '0x8d3dEADbE2b4B857A43331D459270B5eedC7084e'; // Historical  wallet (60%)
...
async function main() {
  ...
  const router = await Router.deploy(_SAFE, DAO_TREASURY, FOUNDER_WALLET);
  ...
  console.log('Split: 60%  / 30% mission infra + AI ops / 10% founder (historical artifact)');
  console.log(':', _SAFE);
