---
name: fables-house
description: Bring up, verify, or heal the entire Sabretooth stack with one command — Postgres, Redis, OmniRoute, frontend, API, tunnel, Mission Control. Use whenever any service/port is down, after a reboot, before a demo, or when asked "is the stack up".
---
...
| Mission Control | 3151 | 200 | `tab-mission-control.cmd` (LOCAL ONLY — no auth!) |
| Stack Health | 8787 | 200 | optional |
| Ollama | 11434 | port | optional; not installed (RTX 3070 8GB can host it) |
