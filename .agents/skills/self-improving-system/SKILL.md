...
- Judge lane: official CLIs only (claude/claude_local LAST resort, codex, gemini, grok — browser-auth signed in). Judges push; agents never push/merge/delete.
- Claude Judge: last resort only — reserved for DREAM Online MMORPG work.
