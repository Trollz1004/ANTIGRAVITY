const DEFAULT_REPLY =
  'Message logged for AI-Solutions support. If this needs a human, escalation is flagged for Hermes/human step-in.';
  ...
  if (upstreamUrl) {
    try {
      ...
      return json({
        ...
        source,
        reply:
          'SupportClaw bridge is not reachable from this deployment yet. Your message was logged and escalation is flagged.',
