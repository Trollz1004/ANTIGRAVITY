      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Devices Recycled</div>
          </div>
          <div className="flex flex-col items-center text-center space-y-2 border-x border-white/5">
            ...
            <div className="text-3xl font-black text-white">$842,000+</div>
            <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Donated to Shriners</div>
          </div>
          <div className="flex flex-col items-center text-center space-y-2">
            <div className="p-3 bg-emerald-500/10 rounded-2xl text-emerald-400">
              <TreeDeciduous size={24} />
            </div>
            <div className="text-3xl font-black text-white">5,200+</div>
            <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Trees Saved</div>
          </div>
        </motion.div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex items-center gap-4 p-6 bg-white/5 border border-white/10 rounded-3xl">
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-gray-400">All donations are verified and tracked on-chain for total accountability.</div>
            </div>
          </div>
        </div>
      </div>
