      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-10">
          <div>
            ...
            <p className={`text-lg ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
              Commercial operations stay product-first, and any kid-focused support follows the current published
              doctrine.
            </p>
          </div>
        ...
        <div className="space-y-3">
          ...
          <p className={`text-xs text-center ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>
            Progress bar will fill as verified revenue is recorded.
          </p>
        </div>
      </div>
