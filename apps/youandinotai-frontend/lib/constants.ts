export const PUBLIC_SURFACES = [
  {
    ...
    description: 'Dating platform with membership, verification, safer chat, profile discovery, and date-planning tools.',
  },
  {
...
export const MEMBERSHIP_PLANS = [
  ...
  },
  {
    ...
    price: '$14.99',
    cadence: '/month',
    blurb: 'Full app access with verification, matching, support, and launch-year member features.',
  ...
  },
  {
    ...
    price: '$2,500',
    cadence: 'lifetime',
    blurb: 'Premium lifetime app access with priority support and account recognition.',
