...
import { Activity, LayoutDashboard, Users, Wallet, ChevronRight, Gavel, TrendingUp, ShieldCheck, Code2, Globe } from 'lucide-react';
...
export function DAOMonitor() {
  ...
  const stats = [
    { label: 'Treasury', value: '$2,450,892', icon: <Wallet size={12} className="text-[#00d4ff]" />, trend: '+12%' },
    ...
    <div className="mt-6 border-t border-[#2a3a52] pt-4 select-none">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest group-hover:text-[#e8f0ff] transition-colors font-mono">Antigravity DAO</span>
        </div>
        <motion.div
