  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-foot">
        ...
        <div className="row"><Icon.Heart size={11} style={{ color: 'var(--rose)' }}/><span>#MembershipVerificationSupport</span></div>
      </div>
    </aside>
  );
}
  ...
  return (
    <>
      <div className="strip">
        ...
        <span className="hot">♡ member support · #MembershipVerificationSupport</span>
