...
Idempotent enough for a clean board: creates the full setup tree from
ANTIGRAVITY Master Plan.html with the max-agent roster assigned to every task.
T5500 is marked blocked/untouched per doctrine.
...
for code, title, comp, owner, body in pipe:
    create(f"{code} {title}", comp, assignee=owner, body=body, priority=3)
