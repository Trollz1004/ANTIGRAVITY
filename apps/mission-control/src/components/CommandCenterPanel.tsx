...
const PLATFORMS = {
  ...
  opus: { label: 'Opus (Claude)', icon: '⚡️', color: '#a78bfa', type: 'llm', claw: 'Orchestrator', api: 'Claude CLI / Account Auth' },
...
const AGENTS: Agent[] = [
  ...
  ['taskqueue', 'CodeX-Task-Queue', 'Task Queue Visibility', 'active', 'Sabretooth', '#64748b', 'Watchers'],
  ...
  ['clawx_claude', 'ClawX-Claude', 'Architecture + Audit', 'active', 'Claude CLI / account auth', '#a78bfa', 'ClawX Council'],
