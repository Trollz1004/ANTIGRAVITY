...
export const TreasuryPanel: React.FC = () => {
  ...
  return (
    <div className="bg-panel rounded border border-border p-4 mb-4">
      <h2 className="text-sm font-mono uppercase tracking-wider text-white mb-2">Antigravity Treasury</h2>
      ...
      <div className="text-xs font-mono text-gray-400 mb-2">
        Treasury view · <span className="text-gray-200">${d?.balanceUsd?.toLocaleString?.() ?? '0'}</span> · {d?.source ?? 'mirror'}
      </div>
