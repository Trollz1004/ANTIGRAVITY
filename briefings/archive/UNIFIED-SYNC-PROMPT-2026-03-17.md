...
## 4. THE MISSION — 60/30/10 SPLIT (PERPETUAL LAW)
...
- **Live contract:** `GospelDonation.sol` at `0x9855B75061D4c841791382998f0CE8B2BCC965A4` on **Base Mainnet**
- **Verified:** Codex confirmed live bytecode + internal transactions matching 60/30/10 on 2026-03-13.
...
- **FL §496.405:** NEVER use "donate" / "donation" / "solicitation" in customer-facing code on the ENIGMA side.
- Correct term: **"contractual revenue disbursement"**
...
- **Identity:** Social platform for good (dating + meetups + volunteering + charity)
...
| On-Chain Proof (60/30/10 Base Mainnet) | ✅ VERIFIED LIVE |
...
2. The 60/30/10 split percentages and who they go to.
...
- "donation" language in ENIGMA-side code
