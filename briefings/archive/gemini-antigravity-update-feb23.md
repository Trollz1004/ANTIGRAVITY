...
6. **GEMINI_API_KEY is baked into the JS bundle** — this is a security concern. The key `***REMOVED***` is visible in client-side code. Consider proxying Gemini calls through backend.
