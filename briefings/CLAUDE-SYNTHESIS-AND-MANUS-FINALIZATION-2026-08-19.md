...
- brain-mcp: stdio mode (the mode actually used) constructs **no authContext** — any caller can claim any platform identity including certification authority; platform registry still grants Manus a lane on retired T5500 (192.168.0.8) and references E:\ paths.
