...
create table if not exists public.revenue_allocations (
    ...
    charitable_amount_cents integer,
    operating_amount_cents integer,
    charitable_percent integer not null default 10,
...
alter table public.revenue_allocations
    ...
    add column if not exists charitable_amount_cents integer,
    add column if not exists operating_amount_cents integer,
    add column if not exists charitable_percent integer not null default 10,
...
alter table public.revenue_allocations
    ...
    alter column charitable_percent set default 10,
