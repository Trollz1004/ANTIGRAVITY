...
async def _send_telegram_support_alert(*, message: str, settings: Settings) -> bool:
    telegram_token = str(settings.telegram_bot_token or "").strip()
