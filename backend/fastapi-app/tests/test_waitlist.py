...
def test_waitlist_signup_sends_confirmation_and_operator_notice(client, monkeypatch):
    ...
    monkeypatch.setattr("app.routers.waitlist.send_waitlist_confirmation", confirmation_mock)
    monkeypatch.setattr("app.routers.waitlist.send_waitlist_operator_notice", operator_mock)
...
def test_waitlist_signup_fails_closed_when_confirmation_unavailable(client, monkeypatch):
