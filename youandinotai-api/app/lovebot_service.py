...
class LoveBotService:
    def __init__(self):
        self.quotes = [
            {"text": "The best thing to hold onto in life is each other.", "author": "Audrey Hepburn", "category": "cute"},
            {"text": "Love is composed of a single soul inhabiting two bodies.", "author": "Aristotle", "category": "deep"},
            {"text": "To love and be loved is to feel the sun from both sides.", "author": "David Viscott", "category": "cute"},
            {"text": "Where there is love there is life.", "author": "Mahatma Gandhi", "category": "aphorism"},
            {"text": "Love is not about how many days, months, or years you have been together. Love is about how much you love each other every single day.", "author": "Unknown", "category": "advice"},
        ]
    ...
    def calculate_compatibility(self, name1: str, name2: str) -> dict:
        ...
        if score > 80:
            ...
            message = "Opposites attract, but it might take some work to find common ground."
