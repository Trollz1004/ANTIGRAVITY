...
| `OMNIROUTE_KEY` | Auth to the above | Optional; canonical OmniRoute auth var (AGENT-DOCTRINE.md), sent as Bearer only if set. `OMNI_API_KEY` accepted as a legacy alias. |
