# Campaign Launch Checklist — Founding Member

**Status:** Ready to launch
**Dependencies:** All cleared (TRO-8 checkout UX done, TRO-13 SEO/readiness done)
...
2. Paste each post in order (6 posts)
3. Include link: https://square.link/u/cxwjcn0s
4. Publish
...
2. Product name: YouAndINotAI
3. Tagline: Verified dating. No bots. Safer plans.
4. Website: https://youandinotai.com
5. Paste description from campaign doc
6. Add screenshots (capture from youandinotai.com)
7. Add maker comment from campaign doc
8. Submit
...
- [ ] Expand to OnlineRecycle and AI Solutions Store campaigns
