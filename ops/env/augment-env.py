...
CONFIG = [
    ...
    ("OPENAI_COMPAT_BASE_URL", "http://192.168.0.8:20128/v1", "OmniRoute — the ONE URL for every client/doc/probe (Joshua 2026-09-03, verified from his tablet over Wi-Fi); 127.0.0.1/localhost//api/v1 forms are retired"),
    ("OMNIROUTE_LAN_BASE_URL", "http://192.168.0.8:20128/v1", ""),
    ("OMNIROUTE_DASHBOARD_URL", "http://192.168.0.8:20128/dashboard", ""),
